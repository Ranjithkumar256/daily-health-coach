#!/usr/bin/env bash
# ==============================================================================
# Daily Health Coach Android One-Click Build Script
...
echo "========================================================"
echo "  🌿 Daily Health Coach Android Build System"
...
cp -r android/app/src/main/assets/public/assets android/app/src/main/assets/public/static/ 2>/dev/null || true
...
if [ "$MODE" == "apk" ] || [ "$MODE" == "all" ]; then
    ...
    cp app/build/outputs/apk/debug/DailyHealthCoach-debug.apk app/build/outputs/apk/debug/app-debug.apk 2>/dev/null || true
    echo "✅ Debug APK built successfully!"
    echo "📍 File: android/app/build/outputs/apk/debug/DailyHealthCoach-debug.apk"
...
if [ "$MODE" == "aab" ] || [ "$MODE" == "all" ]; then
    ...
    cp app/build/outputs/bundle/release/app-release.aab app/build/outputs/bundle/release/DailyHealthCoach-release.aab 2>/dev/null || true
    echo "✅ Signed Android App Bundle (.aab) created successfully!"
    echo "📍 File: android/app/build/outputs/bundle/release/DailyHealthCoach-release.aab"
