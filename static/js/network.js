/**
 * Daily Health Coach - Network Connectivity & Internet Guard
 * Enforces active network connection for sponsor advertisements and tips.
  ...
  const NetworkMonitor = {
    ...
    init() {
      ...
      window.addEventListener('online', () => {
        ...
        if (window.app && window.app.showToast) {
          window.app.showToast('Network connection restored! 🌿', 'success');
        }
      });
        ...
        el.innerHTML = `
          ...
          " id="networkBlockerCard">
            ...
            <p style="font-size: 13px; line-height: 1.55; color: #94a3b8; margin: 0 0 24px;">
              An active Internet connection is required for live sponsor advertisements and health coach telemetry. Your health logs and workout telemetry remain 100% safely preserved on your phone.
            </p>
    ...
    async checkAndRetry() {
      ...
      if (reachable) {
        this.isOnline = true;
        this.updateState();
        if (window.app && window.app.showToast) window.app.showToast('Network restored! 🌿', 'success');
